...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{junho/macos.png}
    \caption{macOS}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{junho/window.jpg}
    \caption{windows11}
\end{figure}
...
Docker containers were configured to host FastAPI and MySQL instances, providing a consistent testbed across both macOS and Windows.  
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{junho/watchos.png}
    \caption{WatchOS}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{dogyeom/env/docker.png}
    \caption{Docker}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{dogyeom/env/featured.png}
    \caption{MySQL}
\end{figure}
MySQL is a widely used open-source relational database management system based on Structured Query Language (SQL).
It provides reliable data storage, indexing, and querying capabilities for web and enterprise applications.
MySQL ensures data integrity through ACID compliance and supports multi-user access with transaction control and authentication mechanisms.
In this project, MySQL was used to manage structured data efficiently, offering strong scalability and compatibility with Docker-based deployments.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{dogyeom/env/1481255846tqt6xgvQFG8YHmFb.png}
    \caption{Google Cloud Platform}
\end{figure}
Google Cloud Platform (GCP) is a comprehensive suite of cloud computing services provided by Google.
It offers scalable infrastructure for computing, storage, networking, and machine learning applications.
GCP enables developers to deploy and manage containerized applications using services such as Cloud Run, Compute Engine, and Kubernetes Engine. In this project, GCP was used to host backend APIs and manage containerized environments with high scalability and reliability.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{dogyeom/env/logo-teal.png}
    \caption{FastAPI}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{dogyeom/env/sig5.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{Donghyun/swift.png}
