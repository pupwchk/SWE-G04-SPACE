...
\hline
User, Customer, Development manager & 
Jun ho Uh & 
...
\hline
Software Developer (Back-end) & Dogyeom Kim & The backend developer is responsible for safety and efficiently handling user data and AI analysis results in SPACE platform development. Dogyeom Kim designs and builds FastAPI-based API servers and implements real-time data management systems using MySQL. Based on the cloud environment, it connects various APIs to manage data, and focuses on communication between users and AI core and ensuring the scalability and stability of the system's Backend infrastructure. \\
\hline
